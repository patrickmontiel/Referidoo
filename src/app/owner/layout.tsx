...
const nav = [
  ...
  { href: "/owner/inteligencia", label: "Inteligencia", icon: "M3 3V21H21M7 14L11 10L14 13L19 7" },
  { href: "/owner/activacion", label: "Activación", icon: "M3 4H21L14 12.5V19L10 21V12.5L3 4Z" },
